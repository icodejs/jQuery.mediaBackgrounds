...
(function($, window, document, undefined) {
    ...
    $.fn.background = function(custom_options) {
        ...
        var base    = this,
            methods = {
                ...
                get_bg: function (elem) {
                    ...
                    if (options.media_type === 'colour') {
                        ...
                        // media_type === img
                        // write some kind of randomizer that will randomize the
                        // search query (rsz=, start=, data.responseData.results[2])
                ...
                set_bg: function (data, elem) {
                    if (options.media_type === 'colour') {
                        ...
                        if (data && data.bg_url) {
                            methods.pre_load_img(data.bg_url, function () {
                                elem.css({
                ...
                pre_load_img: function (src_url, callback, delay) {
                    var image = new Image();
            ...
            options = $.extend({
                search_term: methods.parse_search_term('transformers'),
